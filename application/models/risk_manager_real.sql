...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 23, 2017 lúc 07:53 AM
...
CREATE TABLE `riskfactor-riskevent` (
  `id` int(11) NOT NULL,
  `code` varchar(20) CHARACTER SET utf8 NOT NULL,
  `risk_id` int(11) NOT NULL,
...
(1, '127.0.0.1', 'administrator', 'Administrator', '$2a$06$zfgtNV3sB1gzYS6sKgnn9.9ydzb7RhAdYak0Ww/64DfONO6NsG9Q2', '', 'admin@admin.com', NULL, '', NULL, NULL, NULL, 1268889823, 1508734750, 1, 0);
...
--
-- Chỉ mục cho bảng `conflicts`
--
ALTER TABLE `conflicts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `project_id` (`project_id`),
  ADD KEY `method_1_id` (`method_1_id`),
  ADD KEY `method_2_id` (`method_2_id`);

--
-- Chỉ mục cho bảng `fitness`
--
ALTER TABLE `fitness`
  ADD PRIMARY KEY (`id`),
  ADD KEY `project_id` (`project_id`);
...
ALTER TABLE `goals`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code_3` (`code`,`project_id`),
  ADD KEY `category_id` (`goal_type_id`),
  ADD KEY `parent_goal_id` (`parent_goal_id`),
  ADD KEY `project_id` (`project_id`);

--
-- Chỉ mục cho bảng `goal_categories`
--
...
--
-- Chỉ mục cho bảng `ion_groups`
--
ALTER TABLE `ion_groups`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `ion_login_attempts`
--
ALTER TABLE `ion_login_attempts`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `ion_users_groups`
--
...
--
-- Chỉ mục cho bảng `methods`
--
ALTER TABLE `methods`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `risk_id_2` (`risk_id`,`code`),
  ADD KEY `risk_id` (`risk_id`),
  ADD KEY `responsible_agent_id` (`responsible_agent_id`);
...
--
-- Chỉ mục cho bảng `risk-goal`
--
ALTER TABLE `risk-goal`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD UNIQUE KEY `code_2` (`code`,`risk_id`,`goal_id`),
  ADD KEY `goal_id` (`goal_id`),
  ADD KEY `risk_id` (`risk_id`);

--
-- Chỉ mục cho bảng `riskfactor-riskevent`
--
ALTER TABLE `riskfactor-riskevent`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`,`risk_id`,`risk_factor_id`),
  ADD KEY `project_id` (`project_id`),
  ADD KEY `risk_id` (`risk_id`),
  ADD KEY `risk_factor_id` (`risk_factor_id`);

--
-- Chỉ mục cho bảng `risks`
--
ALTER TABLE `risks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `project_id_2` (`project_id`,`code`),
  ADD KEY `project_id` (`project_id`),
  ADD KEY `risk_type_id` (`risk_type_id`);

--
-- Chỉ mục cho bảng `risk_factors`
--
ALTER TABLE `risk_factors`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`,`project_id`),
  ADD KEY `project_id` (`project_id`);

--
-- Chỉ mục cho bảng `risk_types`
--
...
--
-- AUTO_INCREMENT cho bảng `conflicts`
--
ALTER TABLE `conflicts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT cho bảng `fitness`
--
ALTER TABLE `fitness`
...
--
-- AUTO_INCREMENT cho bảng `goal_categories`
--
ALTER TABLE `goal_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT cho bảng `ion_groups`
--
ALTER TABLE `ion_groups`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT cho bảng `ion_login_attempts`
--
ALTER TABLE `ion_login_attempts`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT cho bảng `ion_users_groups`
--
ALTER TABLE `ion_users_groups`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT cho bảng `methods`
--
ALTER TABLE `methods`
...
--
-- AUTO_INCREMENT cho bảng `risk-goal`
--
ALTER TABLE `risk-goal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT cho bảng `riskfactor-riskevent`
--
ALTER TABLE `riskfactor-riskevent`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT cho bảng `risks`
--
ALTER TABLE `risks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT cho bảng `risk_factors`
--
ALTER TABLE `risk_factors`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT cho bảng `risk_types`
--
ALTER TABLE `risk_types`
